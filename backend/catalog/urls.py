...
from .views import (
    ...
    ElevatorUpdateView,
    ObjectInfoFieldCreateView,
    ObjectInfoFieldDeleteView,
    ObjectInfoFieldListView,
    ObjectInfoFieldReorderView,
    ObjectInfoFieldUpdateView,
...
urlpatterns = [
    ...
    path("settings/object-fields/", ObjectInfoFieldListView.as_view(), name="object-field-list"),
    path(
        "settings/object-fields/create/",
        ObjectInfoFieldCreateView.as_view(),
        name="object-field-create",
    ),
    path(
        "settings/object-fields/<int:pk>/edit/",
        ObjectInfoFieldUpdateView.as_view(),
        name="object-field-update",
    ),
    path(
        "settings/object-fields/<int:pk>/delete/",
        ObjectInfoFieldDeleteView.as_view(),
        name="object-field-delete",
    ),
    path(
        "settings/object-fields/<int:pk>/move/",
        ObjectInfoFieldReorderView.as_view(),
        name="object-field-move",
    ),
